    ...
    dispositivos.forEach((dispositivo) => {
        ...
        if (dispositivo.config.conectado) {
            ...
            if (dispositivo.config.com) {
                ...
                retorno[dispositivo.nombre] = sPort;
            }
        }
    });
...
exports.getDispositivosUsb = (dispositivos, nombre) => {
    const retorno = {}
    dispositivos.forEach((dispositivo) => {
        if (dispositivo.config.conectado) {
            if (dispositivo.config.usb) {
                retorno[dispositivo.nombre] = dispositivo.config
            }
        }
    })
    return retorno
